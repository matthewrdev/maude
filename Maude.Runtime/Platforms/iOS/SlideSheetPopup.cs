...
public sealed class SlideSheetPopup : NSObject, IPopup
{
    private readonly PopupView popupContent;
    ...
    public SlideSheetPopup(PopupView popupContent, UIView platformView, UIViewController hostController)
    {
